                ...
                <div class="card">
                    <div class="body">
                        <div class="table-responsive">
                                <a class="btn btn-success" href="{{route('news.create')}}" ><i class="material-icons">add</i></a>
                            <table id="tableExport" class="display table table-hover table-checkable order-column m-t-20 width-per-100 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a style="color: black;" href="{{route('news.show',$row->id)}}">{{mb_substr($row->title,0,20)}}</a></td>
                                        <td class="text-center"><a style="color: black;" href="{{route('news.show',$row->id)}}">{!!mb_substr($row->body,0,20)!!}</a></td>
                                        <td class="text-center" style="width: 100px; height:100px;"><a style="color: black;" href="{{route('news.show',$row->id)}}"><img src="{{asset('storage/images/news/'.$row->image->path)}}"></a></td>
                                        @if ($row->status==1)
                                        ...
                                        @endif
                                        <td>
                                            <a href="{{route('news.edit',$row->id)}}"class="btn tblActnBtn"><i class="material-icons">mode_edit</i></a>
                                            <a href="" class="button" data-id="{{$row->id}}"class="btn tblActnBtn"><i class="material-icons">mode_delete</i></a>
                                        </td>
                                    </tr> 
                                    @endforeach
