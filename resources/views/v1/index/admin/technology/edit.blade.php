    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="body">
                        <form method="POST" action="/admin/technologies/{{$technology->id}}">
                            @csrf
                            ...
                            <textarea type="text" name="body">{{$technology->body}}</textarea>
                            <div class="form-group">
                                <label>تصویر خبر</label>
                                <input type="hidden" value="{{$technology->image->id}}" name="imageo"><img src="{{asset('storage/images/technologies/'.$technology->image->path)}}">
                            </div>
                            <div class="row mb-6">
                                <label class="col-lg-4 col-form-label required fw-bold fs-6">تصویر خبر</label>
                                <div class="col-lg-8 fv-row">
                                    <input type="hidden" name="technology_image" id="technology-image" value="{{$technology->image_id}}">
...
var drop = new Dropzone('#photo', {
        addRemoveLinks: true,
        maxFiles: 1,
        url: "{{ route('technologies.image') }}",
        sending: function(file, xhr, formData){
          formData.append("_token","{{csrf_token()}}")
        },
        success: function(file, response){
          document.getElementById('technology-image').value = response.technology_image
        }
      });
