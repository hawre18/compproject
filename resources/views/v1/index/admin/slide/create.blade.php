...
<section class="content">
    <div class="container-fluid">
        @include('errors')
        <form id="form_validation" method="POST" action="/admin/slides">
            @csrf
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-8 fv-row">
                <input type="hidden" name="slide_image" id="slide-image">
        ...
        <div class="row mb-6">
            ...
            <!--begin::Col-->
            <div class="col-lg-8 fv-row">
                <textarea type="text" name="link" value="{{old('link')}}" class="form-control form-control-lg form-control-solid" ></textarea>
            </div>
            <!--end::Col-->
        </div>
